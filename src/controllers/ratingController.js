...
export const getRatingByDoctorId = async (req, res) => {
    try {
        ...
        const ratings = await Rating.find({doctorId}).populate('patientId', 'firstName lastName').populate('appointmentId', 'date timeSlot');
...
export const updateRating = async (req, res) => {
    try {
        ...
        if(rating.patientId.toString() !== req.user._id.toString()) //lay user_id tu token
            {
